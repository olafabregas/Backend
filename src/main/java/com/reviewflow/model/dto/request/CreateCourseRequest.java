...
public class CreateCourseRequest {
    ...
    @Schema(description = "Unique course code or identifier", example = "CS101", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED)
    @NotBlank
    private String code;
    ...
    @Schema(description = "Academic term or semester for the course", example = "Spring 2026", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED)
    @NotBlank
    private String term;
