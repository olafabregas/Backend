...
>
> **Related PRDs:** [PRD-03 Email Notifications](../Features/PRD_03_email_notifications.md) | [PRD-04 Announcements](../Features/PRD_04_announcements.md) | [PRD-05 Extensions](../Features/PRD_05_assignment_extensions.md)
> **Related Decisions:** [Decision 11: Event-Driven Notifications](../DECISIONS.md#11-event-driven-async-notifications-over-request-response)
> **Key Concepts:** This module implements the handler side of event-driven notifications. Services publish events (see PRD-03 Full Request Flow); NotificationEventListener captures them and creates in-app notifications and queued emails.
