...
>
> **Related PRDs:** [PRD-08 Logging and Monitoring](../Features/PRD_08_logging_monitoring.md) | [PRD-09 System Admin](../Features/PRD9-SystemAdmin.md)
> **Related Modules:** [Module 11: System Admin](./11_Module_SystemAdmin.md) (platform operator features) | [Module 12: Monitoring](./12_Module_Monitoring.md) (audit logs and metrics)
> **Related Decisions:** [Decision 16: Role Hierarchy](../DECISIONS.md#16-role-hierarchy-system_admin--admin--instructor--student)
> **Key Concepts:** This module provides academic administration features (user management, course oversight, audit log queries). Platform operator features (cache management, force logout, infrastructure metrics) live in [Module 11: System Admin](./11_Module_SystemAdmin.md).
